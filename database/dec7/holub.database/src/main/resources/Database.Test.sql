...
delete from name where last like '%ese%'

select * from address
select * from name

select first, last from name where last = 'Flintstone'
select first, last, street, city, zip from name, address where name.addrId = address.addrId
...
select first, last, street, city, zip, description from name, address, id where name.addrId = address.addrId AND name, addrId = id.addrId

drop table id
select first, last from name where last = 'Flintstone' and first = 'Fred' or first like '%lle%'
